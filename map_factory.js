...
class MapFactory {
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                worldHeight = 1580;
                bp(new UnstickableBlock(1110, 140, 40, 290));
                bp(new DeathBlock(1150, 140, 90, 40));
                bp(new UnstickableBlock(1240, 140, 40, 370));
                bp(new Block(460, 220, 430, 40));
                bp(new DeathBlock(890, 220, 90, 40));
                bp(new Block(980, 220, 40, 40));
                bp(new Block(460, 260, 40, 520));
                bp(new UnstickableBlock(720, 260, 40, 250));
                bp(new UnstickableBlock(850, 260, 40, 30));
                bp(new UnstickableBlock(980, 260, 40, 150));
                bp(new Block(590, 330, 20, 550));
                bp(new UnstickableBlock(610, 330, 20, 520));
                bp(new UnstickableBlock(850, 340, 40, 510));
                bp(new Block(980, 410, 20, 60));
                bp(new UnstickableBlock(1000, 410, 20, 60));
                bp(new Block(1020, 430, 110, 40));
                bp(new UnstickableBlock(1130, 430, 20, 370));
                bp(new Block(1110, 470, 20, 330));
                bp(new Block(1240, 510, 40, 60));
                bp(new UnstickableBlock(980, 520, 40, 330));
                bp(new Block(0, 530, 460, 30));
                bp(new Block(0, 560, 30, 1020));
                bp(new Block(170, 560, 70, 220));
                bp(new UnstickableBlock(720, 560, 40, 290));
                bp(new RespawnArea(1290, 570, 50, 50));
                bp(new UnstickableBlock(1240, 620, 40, 230));
                bp(new Block(330, 630, 40, 250));
                bp(new RespawnArea(180, 790, 50, 50));
                bp(new Block(170, 850, 160, 30));
                bp(new DeathBlock(370, 850, 90, 30));
                bp(new Block(460, 850, 130, 30));
                bp(new Block(610, 850, 20, 30));
                bp(new DeathBlock(630, 850, 90, 30));
                bp(new Block(720, 850, 40, 30));
                bp(new Trampoline(760, 850, 90, 30));
                bp(new Block(850, 850, 40, 60));
                bp(new Trampoline(890, 850, 90, 30));
                bp(new Block(980, 850, 170, 30));
                bp(new Trampoline(1150, 850, 90, 30));
                bp(new Block(1240, 850, 750, 30));
                bp(new UnstickableBlock(170, 880, 70, 30));
                bp(new Block(240, 880, 80, 30));
                bp(new UnstickableBlock(320, 880, 160, 30));
                bp(new Block(480, 880, 90, 30));
                bp(new UnstickableBlock(570, 880, 180, 30));
                bp(new Block(750, 880, 100, 30));
                bp(new Block(890, 880, 30, 30));
                bp(new UnstickableBlock(920, 880, 180, 30));
                bp(new Block(1100, 880, 270, 30));
                bp(new UnstickableBlock(1370, 880, 180, 30));
                bp(new Block(1550, 880, 440, 30));
                bp(new Block(1670, 910, 40, 220));
                bp(new Block(1960, 910, 30, 670));
                bp(new UnstickableBlock(170, 990, 40, 210));
                bp(new Block(1780, 1030, 40, 230));
                bp(new RespawnArea(1720, 1140, 50, 50));
                bp(new Trampoline(30, 1200, 140, 30));
                bp(new Block(170, 1200, 40, 60));
                bp(new DeathBlock(210, 1200, 1340, 30));
                bp(new Block(1550, 1200, 230, 60));
                bp(new Block(30, 1230, 140, 30));
                bp(new Block(210, 1230, 1340, 30));
                bp(new Block(1780, 1410, 40, 170));
                bp(new Block(220, 1510, 130, 70));
                bp(new Block(600, 1510, 190, 70));
                bp(new Block(30, 1550, 190, 30));
                bp(new DeathBlock(350, 1550, 250, 30));
                bp(new DeathBlock(790, 1550, 990, 30));
                bp(new Trampoline(1820, 1550, 140, 30));
                player = new Player(70, 1510);
                break;
            }
            default:
