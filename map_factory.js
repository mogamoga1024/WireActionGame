    ...
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                ...
                bp(new DeathBlock(9520, 130, 40, 790));
                bp(new DeathBlock(9800, 130, 270, 20));
                bp(new DeathBlock(10090, 130, 70, 10));
                bp(new DeathBlock(10170, 130, 50, 10));
                bp(new DeathBlock(10230, 130, 50, 10));
                bp(new DeathBlock(10290, 130, 10, 80));
                bp(new DeathBlock(10360, 130, 10, 60));
                bp(new DeathBlock(10380, 130, 10, 60));
                bp(new DeathBlock(6790, 140, 290, 20));
                bp(new Block(7080, 140, 320, 20));
                bp(new DeathBlock(10090, 140, 10, 70));
                bp(new DeathBlock(10170, 140, 10, 70));
                bp(new DeathBlock(10210, 140, 10, 70));
                bp(new DeathBlock(10230, 140, 10, 70));
                bp(new DeathBlock(10270, 140, 10, 70));
                bp(new UnstickableBlock(4570, 150, 300, 40));
                bp(new DeathBlock(5050, 150, 180, 20));
                bp(new DeathBlock(9800, 150, 20, 170));
                bp(new Block(9820, 150, 250, 20));
                ...
                bp(new DeathBlock(10110, 160, 50, 10));
                bp(new DeathBlock(10240, 160, 30, 10));
                bp(new Block(5050, 170, 180, 20));
                bp(new Block(9820, 170, 20, 170));
                bp(new DeathBlock(10130, 170, 10, 40));
                bp(new DeathBlock(10150, 170, 10, 40));
                ...
                bp(new DeathBlock(10100, 200, 30, 10));
                bp(new DeathBlock(10180, 200, 30, 10));
                bp(new DeathBlock(10300, 200, 50, 10));
                bp(new DeathBlock(10360, 200, 10, 10));
                bp(new DeathBlock(10380, 200, 10, 10));
                bp(new Block(5390, 210, 180, 20));
                bp(new Block(5730, 210, 180, 20));
                bp(new RespawnArea(4740, 230, 50, 50));
                bp(new GoalArea(10100, 230, 280, 110));
                ...
                bp(new DeathBlock(9760, 300, 40, 20));
                bp(new DeathBlock(9760, 320, 20, 220));
                bp(new Block(9780, 320, 40, 20));
                bp(new UnstickableBlock(4720, 330, 40, 1450));
                bp(new RespawnArea(8790, 330, 50, 50));
                bp(new Block(9780, 340, 20, 220));
                bp(new UnstickableBlock(10090, 350, 300, 40));
                ...
                bp(new DeathBlock(9990, 670, 40, 120));
                bp(new DeathBlock(10070, 670, 40, 120));
                bp(new DeathBlock(10130, 670, 120, 40));
                bp(new DeathBlock(10270, 670, 40, 240));
                bp(new DeathBlock(10350, 670, 40, 240));
                bp(new Block(4410, 680, 40, 230));
                bp(new Block(8040, 690, 20, 50));
                bp(new Block(1120, 700, 20, 330));
                bp(new DeathBlock(4810, 700, 180, 20));
                bp(new DeathBlock(10130, 710, 40, 200));
                bp(new DeathBlock(10210, 710, 40, 200));
                ...
                bp(new DeathBlock(10030, 790, 40, 120));
                ...
                bp(new DeathBlock(10170, 870, 40, 40));
                bp(new DeathBlock(10310, 870, 40, 40));
                bp(new Block(9520, 920, 20, 500));
                bp(new DeathBlock(9540, 920, 20, 140));
                bp(new DeathBlock(5410, 930, 180, 20));
                bp(new DeathBlock(5040, 940, 180, 20));
                bp(new DeathBlock(9600, 940, 80, 20));
                ...
                bp(new DeathBlock(9600, 960, 20, 100));
                bp(new Block(9620, 960, 80, 20));
                bp(new Block(5860, 970, 180, 20));
                bp(new Block(9620, 980, 20, 260));
                ...
                bp(new Block(9540, 1080, 20, 340));
                bp(new Block(9600, 1080, 20, 160));
                ...
                bp(new RespawnArea(2660, 1130, 50, 50, "left"));
                ...
                bp(new Block(9680, 1240, 40, 100));
                bp(new Block(4120, 1250, 70, 40));
                bp(new RespawnArea(5940, 1250, 50, 50, "left"));
                bp(new RespawnArea(7690, 1250, 50, 50, "left"));
                ...
                bp(new Block(9760, 1340, 40, 180));
                bp(new RespawnArea(1730, 1350, 50, 50, "left"));
                ...
                bp(new DeathBlock(8980, 1740, 1440, 40));
