...
class MapFactory {
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                worldHeight = 1380;
                bp(new Block(460, 20, 300, 40));
                bp(new Block(460, 60, 40, 520));
                bp(new UnstickableBlock(720, 60, 20, 250));
                bp(new Block(740, 60, 20, 250));
                bp(new Block(590, 130, 20, 550));
                bp(new UnstickableBlock(610, 130, 20, 520));
                bp(new Block(0, 330, 460, 30));
                bp(new Block(0, 360, 30, 1020));
                bp(new Block(170, 360, 70, 220));
                bp(new UnstickableBlock(720, 360, 20, 290));
                bp(new Block(740, 360, 20, 320));
                bp(new Block(330, 430, 40, 250));
                bp(new RespawnArea(180, 590, 50, 50));
                bp(new Block(170, 650, 160, 30));
                bp(new DeathBlock(370, 650, 90, 30));
                bp(new Block(460, 650, 130, 30));
                bp(new Block(610, 650, 20, 30));
                bp(new DeathBlock(630, 650, 90, 30));
                bp(new Block(720, 650, 20, 30));
                bp(new Block(760, 650, 1230, 30));
                bp(new UnstickableBlock(170, 680, 70, 30));
                bp(new Block(240, 680, 80, 30));
                bp(new UnstickableBlock(320, 680, 160, 30));
                bp(new Block(480, 680, 90, 30));
                bp(new UnstickableBlock(570, 680, 180, 30));
                bp(new Block(750, 680, 170, 30));
                bp(new UnstickableBlock(920, 680, 180, 30));
                bp(new Block(1100, 680, 270, 30));
                bp(new UnstickableBlock(1370, 680, 180, 30));
                bp(new Block(1550, 680, 440, 30));
                bp(new Block(1670, 710, 40, 220));
                bp(new Block(1960, 710, 30, 670));
                bp(new UnstickableBlock(170, 790, 40, 210));
                bp(new Block(1780, 830, 40, 230));
                bp(new RespawnArea(1720, 940, 50, 50));
                bp(new Trampoline(30, 1000, 140, 30));
                bp(new Block(170, 1000, 40, 60));
                bp(new DeathBlock(210, 1000, 1340, 30));
                bp(new Block(1550, 1000, 230, 60));
                bp(new Block(30, 1030, 140, 30));
                bp(new Block(210, 1030, 1340, 30));
                bp(new Block(1780, 1210, 40, 170));
                bp(new Block(220, 1310, 130, 70));
                bp(new Block(600, 1310, 190, 70));
                bp(new Block(30, 1350, 190, 30));
                bp(new DeathBlock(350, 1350, 250, 30));
                bp(new DeathBlock(790, 1350, 990, 30));
                bp(new Trampoline(1820, 1350, 140, 30));
                player = new Player(70, 1310);
                break;
            }
            default:
