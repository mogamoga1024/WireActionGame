...
class MapFactory {
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                worldHeight = 1700;
                bp(new UnstickableBlock(6280, 0, 40, 1400));
                ...
                bp(new DeathBlock(5720, 150, 180, 20));
                bp(new Block(5720, 170, 180, 20));
                ...
                bp(new DeathBlock(4810, 920, 180, 20));
                bp(new RespawnArea(190, 940, 50, 50));
                bp(new Block(4810, 940, 180, 20));
                ...
                bp(new DeathBlock(5210, 1040, 180, 20));
                bp(new RespawnArea(2660, 1050, 50, 50));
                bp(new Block(5210, 1060, 180, 20));
                ...
                bp(new DeathBlock(4810, 1280, 180, 20));
                bp(new Block(3700, 1290, 70, 40));
                bp(new Block(4810, 1300, 180, 20));
                ...
                bp(new DeathBlock(5210, 1360, 1070, 40));
                ...
                bp(new Block(4870, 1600, 40, 40));
                bp(new Block(5010, 1600, 40, 40));
