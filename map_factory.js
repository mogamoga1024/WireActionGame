    ...
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                ...
                bp(new RespawnArea(1290, 580, 60, 60));
                ...
                bp(new Block(1240, 860, 750, 30));
                bp(new UnstickableBlock(170, 890, 70, 30));
                bp(new Block(240, 890, 80, 30));
                bp(new UnstickableBlock(320, 890, 160, 30));
