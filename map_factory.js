    ...
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                ...
                bp(new Block(1280, 150, 450, 40));
                bp(new DeathBlock(1730, 150, 200, 40));
                bp(new DeathBlock(1890, 190, 40, 240));
                bp(new RespawnArea(1370, 200, 50, 50));
                bp(new Block(460, 230, 430, 40));
                bp(new DeathBlock(890, 230, 90, 40));
                bp(new Block(980, 230, 40, 40));
                bp(new Block(1370, 260, 410, 20));
                bp(new UnstickableBlock(1780, 260, 20, 40));
                ...
                bp(new Block(1370, 280, 40, 610));
                bp(new UnstickableBlock(1410, 280, 370, 20));
                bp(new Block(590, 340, 20, 550));
                bp(new UnstickableBlock(610, 340, 20, 520));
                bp(new UnstickableBlock(850, 350, 40, 510));
                bp(new Block(1490, 390, 240, 40));
                bp(new DeathBlock(1730, 390, 160, 40));
