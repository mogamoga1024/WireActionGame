...
class MapFactory {
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                worldHeight = 1360;
                bp(new Block(460, 0, 430, 40));
                bp(new DeathBlock(890, 0, 90, 40));
                bp(new Block(980, 0, 40, 40));
                bp(new UnstickableBlock(1110, 0, 40, 210));
                bp(new DeathBlock(1150, 0, 90, 40));
                bp(new UnstickableBlock(1240, 0, 40, 290));
                bp(new Block(460, 40, 40, 520));
                bp(new UnstickableBlock(720, 40, 40, 250));
                bp(new UnstickableBlock(850, 40, 40, 30));
                bp(new UnstickableBlock(980, 40, 40, 150));
                bp(new Block(590, 110, 20, 550));
                bp(new UnstickableBlock(610, 110, 20, 520));
                bp(new UnstickableBlock(850, 120, 40, 510));
                bp(new Block(980, 190, 20, 60));
                bp(new UnstickableBlock(1000, 190, 20, 60));
                bp(new Block(1020, 210, 110, 40));
                bp(new UnstickableBlock(1130, 210, 20, 370));
                bp(new Block(1110, 250, 20, 330));
                bp(new Block(1240, 290, 40, 60));
                bp(new UnstickableBlock(980, 300, 40, 330));
                bp(new Block(0, 310, 460, 30));
                bp(new Block(0, 340, 30, 1020));
                bp(new Block(170, 340, 70, 220));
                bp(new UnstickableBlock(720, 340, 40, 290));
                bp(new RespawnArea(1290, 350, 50, 50));
                bp(new UnstickableBlock(1240, 400, 40, 230));
                bp(new Block(330, 410, 40, 250));
                bp(new RespawnArea(180, 570, 50, 50));
                bp(new Block(170, 630, 160, 30));
                bp(new DeathBlock(370, 630, 90, 30));
                bp(new Block(460, 630, 130, 30));
                bp(new Block(610, 630, 20, 30));
                bp(new DeathBlock(630, 630, 90, 30));
                bp(new Block(720, 630, 40, 30));
                bp(new Trampoline(760, 630, 90, 30));
                bp(new Block(850, 630, 40, 60));
                bp(new Trampoline(890, 630, 90, 30));
                bp(new Block(980, 630, 170, 30));
                bp(new Trampoline(1150, 630, 90, 30));
                bp(new Block(1240, 630, 750, 30));
                bp(new UnstickableBlock(170, 660, 70, 30));
                bp(new Block(240, 660, 80, 30));
                bp(new UnstickableBlock(320, 660, 160, 30));
                bp(new Block(480, 660, 90, 30));
                bp(new UnstickableBlock(570, 660, 180, 30));
                bp(new Block(750, 660, 100, 30));
                bp(new Block(890, 660, 30, 30));
                bp(new UnstickableBlock(920, 660, 180, 30));
                bp(new Block(1100, 660, 270, 30));
                bp(new UnstickableBlock(1370, 660, 180, 30));
                bp(new Block(1550, 660, 440, 30));
                bp(new Block(1670, 690, 40, 220));
                bp(new Block(1960, 690, 30, 670));
                bp(new UnstickableBlock(170, 770, 40, 210));
                bp(new Block(1780, 810, 40, 230));
                bp(new RespawnArea(1720, 920, 50, 50));
                bp(new Trampoline(30, 980, 140, 30));
                bp(new Block(170, 980, 40, 60));
                bp(new DeathBlock(210, 980, 1340, 30));
                bp(new Block(1550, 980, 230, 60));
                bp(new Block(30, 1010, 140, 30));
                bp(new Block(210, 1010, 1340, 30));
                bp(new Block(1780, 1190, 40, 170));
                bp(new Block(220, 1290, 130, 70));
                bp(new Block(600, 1290, 190, 70));
                bp(new Block(30, 1330, 190, 30));
                bp(new DeathBlock(350, 1330, 250, 30));
                bp(new DeathBlock(790, 1330, 990, 30));
                bp(new Trampoline(1820, 1330, 140, 30));
                player = new Player(70, 1290);
                break;
            }
            default:
