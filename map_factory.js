...
class MapFactory {
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                worldHeight = 1590;
                bp(new UnstickableBlock(1110, 150, 40, 290));
                bp(new DeathBlock(1150, 150, 90, 40));
                bp(new UnstickableBlock(1240, 150, 40, 350));
                bp(new Block(1280, 150, 220, 40));
                bp(new DeathBlock(1500, 150, 730, 40));
                bp(new DeathBlock(2190, 190, 40, 240));
                bp(new RespawnArea(1370, 200, 50, 50));
                bp(new Block(460, 230, 430, 40));
                bp(new DeathBlock(890, 230, 90, 40));
                bp(new Block(980, 230, 40, 40));
                bp(new Block(1370, 260, 20, 630));
                bp(new UnstickableBlock(1390, 260, 640, 40));
                bp(new Block(2030, 260, 50, 20));
                bp(new UnstickableBlock(2080, 260, 20, 40));
                bp(new Block(460, 270, 40, 520));
                bp(new UnstickableBlock(720, 270, 40, 250));
                bp(new UnstickableBlock(850, 270, 40, 30));
                bp(new UnstickableBlock(980, 270, 40, 150));
                bp(new UnstickableBlock(2030, 280, 50, 20));
                bp(new DeathBlock(1390, 300, 20, 260));
                bp(new Block(590, 340, 20, 550));
                bp(new UnstickableBlock(610, 340, 20, 520));
                bp(new UnstickableBlock(850, 350, 40, 510));
                bp(new UnstickableBlock(1500, 390, 20, 40));
                bp(new Block(1520, 390, 50, 20));
                bp(new UnstickableBlock(1570, 390, 460, 40));
                bp(new DeathBlock(2030, 390, 160, 40));
                bp(new UnstickableBlock(1520, 410, 50, 20));
                bp(new Block(980, 420, 20, 60));
                bp(new UnstickableBlock(1000, 420, 20, 60));
                bp(new DeathBlock(1900, 430, 50, 150));
                bp(new Block(1020, 440, 110, 40));
                bp(new UnstickableBlock(1130, 440, 20, 370));
                bp(new Block(1110, 480, 20, 330));
                bp(new Block(1240, 500, 40, 80));
                bp(new DeathBlock(1410, 520, 160, 40));
                bp(new UnstickableBlock(1570, 520, 150, 40));
                bp(new UnstickableBlock(980, 530, 40, 330));
                bp(new Block(0, 540, 460, 30));
                bp(new Block(1390, 560, 20, 330));
                bp(new Block(0, 570, 30, 1020));
                bp(new Block(170, 570, 70, 220));
                bp(new UnstickableBlock(720, 570, 40, 290));
                bp(new Block(1900, 580, 50, 50));
                bp(new Block(330, 640, 40, 250));
                bp(new UnstickableBlock(1240, 640, 40, 220));
                bp(new RespawnArea(180, 800, 50, 50));
                bp(new RespawnArea(2160, 800, 50, 50));
                bp(new Block(170, 860, 160, 30));
                bp(new DeathBlock(370, 860, 90, 30));
                bp(new Block(460, 860, 130, 30));
                bp(new Block(610, 860, 20, 30));
                bp(new DeathBlock(630, 860, 90, 30));
                bp(new Block(720, 860, 40, 30));
                bp(new Trampoline(760, 860, 90, 30));
                bp(new Block(850, 860, 40, 60));
                bp(new Trampoline(890, 860, 90, 30));
                bp(new Block(980, 860, 170, 30));
                bp(new Trampoline(1150, 860, 90, 30));
                bp(new Block(1240, 860, 40, 60));
                bp(new Trampoline(1280, 860, 90, 30));
                bp(new DeathBlock(1410, 860, 740, 30));
                bp(new Block(2150, 860, 120, 60));
                bp(new UnstickableBlock(170, 890, 70, 30));
                bp(new Block(240, 890, 50, 30));
                bp(new UnstickableBlock(290, 890, 190, 30));
                bp(new Block(480, 890, 90, 30));
                bp(new UnstickableBlock(570, 890, 180, 30));
                bp(new Block(750, 890, 100, 30));
                bp(new Block(890, 890, 30, 30));
                bp(new UnstickableBlock(920, 890, 180, 30));
                bp(new Block(1100, 890, 140, 30));
                bp(new Block(1280, 890, 90, 30));
                bp(new UnstickableBlock(1370, 890, 180, 30));
                bp(new Block(1550, 890, 440, 30));
                bp(new DeathBlock(1990, 890, 160, 30));
                bp(new Block(1670, 920, 40, 220));
                bp(new Block(1960, 920, 30, 670));
                bp(new UnstickableBlock(170, 1000, 40, 210));
                bp(new Block(1780, 1040, 40, 230));
                bp(new RespawnArea(1720, 1150, 50, 50));
                bp(new Trampoline(30, 1210, 140, 30));
                bp(new Block(170, 1210, 40, 60));
                bp(new DeathBlock(210, 1210, 1340, 30));
                bp(new Block(1550, 1210, 230, 60));
                bp(new Block(30, 1240, 140, 30));
                bp(new Block(210, 1240, 1340, 30));
                bp(new Block(1780, 1420, 40, 170));
                bp(new Block(220, 1520, 130, 70));
                bp(new Block(600, 1520, 190, 70));
                bp(new Block(30, 1560, 190, 30));
                bp(new DeathBlock(350, 1560, 250, 30));
                bp(new DeathBlock(790, 1560, 990, 30));
                bp(new Trampoline(1820, 1560, 140, 30));
                player = new Player(70, 1520);
                break;
            }
            default:
