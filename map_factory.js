    ...
    static create(name) {
        ...
        switch (name) {
            ...
            case "hard": {
                ...
                bp(new DeathBlock(9800, 150, 20, 140));
                ...
                bp(new RespawnArea(10100, 230, 280, 110));
                ...
                bp(new DeathBlock(9760, 270, 40, 20));
                ...
                bp(new DeathBlock(9760, 290, 20, 140));
                bp(new Block(9780, 290, 40, 20));
                bp(new Block(6480, 300, 20, 150));
                bp(new UnstickableBlock(6500, 300, 20, 710));
                bp(new Block(9780, 310, 20, 140));
                ...
                bp(new DeathBlock(9720, 410, 40, 20));
                ...
                bp(new DeathBlock(9720, 430, 20, 140));
                bp(new Block(9740, 430, 40, 20));
