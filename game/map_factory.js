    ...
    static create(name, respawnId) {
        ...
        switch (name) {
            ...
            case "hard": {
                ...
                bp(new RespawnArea(6530, 350, 50, 50, "right", 1));
                ...
                bp(new RespawnArea(4740, 380, 50, 50, "right", 2));
                ...
                bp(new RespawnArea(8790, 480, 50, 50, "right", 3));
                ...
                bp(new RespawnArea(1380, 570, 50, 50, "right", 4));
                ...
                bp(new RespawnArea(190, 1170, 50, 50, "right", 5));
                bp(new Block(6600, 1180, 40, 20));
                bp(new Block(6720, 1180, 40, 20));
                bp(new Block(6840, 1180, 40, 20));
                bp(new Block(6960, 1180, 40, 20));
                bp(new Block(7080, 1180, 40, 20));
                bp(new Block(7200, 1180, 40, 20));
                bp(new Block(7320, 1180, 40, 20));
                bp(new Block(7440, 1180, 130, 20));
                ...
                bp(new RespawnArea(2660, 1280, 50, 50, "left", 6));
                ...
                bp(new RespawnArea(5940, 1400, 50, 50, "left", 7));
                bp(new RespawnArea(7690, 1400, 50, 50, "left", 8));
                ...
                bp(new DeathBlock(6300, 1460, 180, 20));
                ...
                bp(new RespawnArea(1730, 1500, 50, 50, "left", 9));
                ...
                bp(new RespawnArea(3150, 1830, 50, 50, "right", 10));
                bp(new Block(4920, 1830, 130, 40));
                bp(new Block(5150, 1830, 40, 40));
                bp(new Block(5290, 1830, 40, 40));
                bp(new RespawnArea(6440, 1830, 50, 50, "right", 11));
